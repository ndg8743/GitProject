...
cf_by='runneradmin'
cf_email=''
cf_time='Sun Feb  2 21:47:48 UTC 2025'
charbits='8'
charsize='1'
chgrp=''
chmod='chmod'
...
cpprun='gcc  -E'
cppstdin='gcc  -E'
cppsymbols='__amd64__=1 __amd64=1 __BYTE_ORDER__=1234 __CYGWIN__=1 __GNUC__=13 __GNUC_MINOR__=3 __LP64__=1 __MSYS__=1 __pic__=1 __PIC__=1 __STDC__=1 __unix__=1 __unix=1 __x86_64__=1 __x86_64=1 _GNU_SOURCE=1 _LONG_DOUBLE=long\ double _LP64=1 _POSIX_C_SOURCE=200809L _POSIX_SOURCE=1 _XOPEN_SOURCE_EXTENDED=1 _XOPEN_SOURCE=700 unix=1'
...
mydomain='.vnnv1tgpcdcu5bmeqdwfnw1vse.dx.internal.cloudapp.net'
myhostname='fv-az834-881'
myuname='cygwin_nt-10.0-26100 fv-az834-881 3.5.7-2644508f.x86_64 2025-01-30 09:08 utc x86_64 cygwin '
n='-n'
need_va_copy='undef'
netdb_hlen_type='int'
