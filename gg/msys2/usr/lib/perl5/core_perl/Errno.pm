...
"x86_64-cygwin-thread-multi-3.5.7-2644508f.x86_64" or
	die "Errno architecture (x86_64-cygwin-thread-multi-3.5.7-2644508f.x86_64) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
